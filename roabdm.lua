			for _ = 1,12 do
		wait()
		game:GetService("ReplicatedStorage").Damage4Bootleg:FireServer(game.Players.LocalPlayer.Character.Humanoid, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame, 0, 0, Vector3.new(0, 0, 0), 5, "", 1, 1)
		game:GetService("ReplicatedStorage").Damage2:FireServer(game.Players.LocalPlayer.Character.Humanoid, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame, 0, 0, Vector3.new(0, 0, 0), 5, "", 1, 1)
		end
function trans1()
...
local damageevent = replicatedstorage.Damage2 --Damage3EldritchNEW
